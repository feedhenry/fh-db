...
exports.parseMongoConnectionURL = function (mongoConnectionURL) {
  ...
  //The connection string will be of the form mongodb://username:pass@db1.prv.mbaas2.cluster.feedhenry.net,db2.prv.mbaas2.cluster.feedhenry.net:27017/domain-vvuq7douloe2zkyktub7fcmt-demos-dev?replicaSet=cluster-mbaas2_rs1
  ...
  assert.notEqual(result.database.host, 0, 'at least one host must be specified in the mongodb connection string');
  assert.notEqual(result.database.port, 0, 'at least one host must be specified in the mongodb connection string');
